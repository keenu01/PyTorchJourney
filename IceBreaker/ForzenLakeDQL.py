...
class FrozenLakeDQL():
    ...
    def train(self, episodes, render=False, is_slippery=False):
        ...
        policy_dqn = DQN(IN=num_states, HID=num_states, OUT=num_actions)
        target_dqn = DQN(IN=num_states, HID=num_states, OUT=num_actions)
        ...
        # Save policy
        t.save(policy_dqn.state_dict(), "frozen_lake_dql.pt")
    ...
    def test(self, episodes, is_slippery=False):
        ...
        # Load learned policy
        policy_dqn = DQN(IN=num_states, HID=num_states, OUT=num_actions) 
        policy_dqn.load_state_dict(t.load("frozen_lake_dql.pt"))
